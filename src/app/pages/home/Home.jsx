        ...
        <div className='begin-recap-section'>
          ...
          <div className='recap-actions'>
            <div className='log-in-discord'>
              <div onClick={() => window.location.replace('https://discordapp.com/api/oauth2/authorize?client_id=658006978022342656&redirect_uri=https%3A%2F%2F2019.bnbdiscord.net&response_type=code&scope=identify')} 
